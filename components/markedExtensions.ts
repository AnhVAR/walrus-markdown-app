...
export const suiConnectExtension = {
    name: 'sui-connect',
    level: 'block',
    start(src: string) { return src.match(/:::sui-connect/)?.index; },
...
// <script type="module">
            ...
            // loadWallets();
            // </script>
export const walruscanExtension = {
    name: 'walruscan',
    level: 'block',
    start(src: string) { return src.match(/:::walruscan/)?.index; },
    tokenizer(src: string) {
...
export const suiscanExtension = {
    name: 'suiscan',
    level: 'block',
    start(src: string) { return src.match(/:::suiscan/)?.index; },
    tokenizer(src: string) {
...
export const walrusImageExtension = {
    name: 'walrus-image',
    level: 'block',
    start(src: string) { return src.match(/:::walrus-image/)?.index; },
    tokenizer(src: string) {
